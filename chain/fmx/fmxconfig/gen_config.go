...
func (c Config) MarshalTOML() (interface{}, error) {
	...
	enc.FerminuxAllowDeepReorg = c.FerminuxAllowDeepReorg
	enc.FilterLogCacheSize = c.FilterLogCacheSize
	enc.Miner = c.Miner
	enc.Powhash = c.Powhash
	enc.TxPool = c.TxPool
	enc.GPO = c.GPO
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.FerminuxAllowDeepReorg != nil {
		c.FerminuxAllowDeepReorg = *dec.FerminuxAllowDeepReorg
	}
