...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *fmxproto.Response) (*fmxproto.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *fmxproto.Response) (int, error) {
	txs, uncles := packet.Res.(*fmxproto.BlockBodiesPacket).Unpack()
