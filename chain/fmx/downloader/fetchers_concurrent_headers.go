...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *fmxproto.Response) (*fmxproto.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *fmxproto.Response) (int, error) {
	headers := *packet.Res.(*fmxproto.BlockHeadersPacket)
