...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *fmxproto.Response) (*fmxproto.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *fmxproto.Response) (int, error) {
	receipts := *packet.Res.(*fmxproto.ReceiptsPacket)
