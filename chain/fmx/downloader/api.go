...
// Syncing provides information when this nodes starts synchronising with the Ferminux network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ferminux.SyncProgress `json:"status"`
}
