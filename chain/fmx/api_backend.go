...
// EthAPIBackend implements fmxapi.Backend for full nodes
...
func (b *EthAPIBackend) SyncProgress() ferminux.SyncProgress {
...
func (b *EthAPIBackend) ChainDb() fmxdb.Database {
