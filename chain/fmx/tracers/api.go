...
// NewAPI creates a new API definition for the tracing methods of the Ferminux service.
...
type TraceCallConfig struct {
	TraceConfig
	StateOverrides *fmxapi.StateOverride
	BlockOverrides *fmxapi.BlockOverrides
}
...
func (api *API) TraceCall(ctx context.Context, args fmxapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
