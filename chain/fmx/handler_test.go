...
// testHandler is a live implementation of the Ferminux protocol handler, just
...
func newTestHandlerWithBlocks(blocks int) *testHandler {
	...
	bs, _ := core.GenerateChain(params.TestChainConfig, chain.Genesis(), powhash.NewFaker(), db, blocks, nil)
