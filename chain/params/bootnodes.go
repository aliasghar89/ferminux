...
import "github.com/aliasghar89/ferminux/chain/common"

// MainnetBootnodes are the upstream mainnet bootnodes (not used by Ferminux).
var MainnetBootnodes = []string{
	// Upstream mainnet bootnodes (not used by Ferminux)
...
var GoerliBootnodes = []string{
	...
	// Ethereum Foundation bootnode (upstream, not used by Ferminux)
