...
type LesOdrRequest interface {
	...
	Validate(fmxdb.Database, *Msg) error
}
...
func (r *BlockRequest) Validate(db fmxdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ReceiptsRequest) Validate(db fmxdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TrieRequest) Validate(db fmxdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *CodeRequest) Validate(db fmxdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *ChtRequest) Validate(db fmxdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *BloomRequest) Validate(db fmxdb.Database, msg *Msg) error {
...
// returns true and stores results in memory if the message was a valid reply
// to the request (implementation of LesOdrRequest)
func (r *TxStatusRequest) Validate(db fmxdb.Database, msg *Msg) error {
