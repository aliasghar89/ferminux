...
func NewLesOdr(db fmxdb.Database, config *light.IndexerConfig, peers *serverPeerSet, retriever *retrieveManager) *LesOdr {
	return &LesOdr{
		db:            db,
...
func (odr *LesOdr) Database() fmxdb.Database {
	return odr.db
}
