...
type downloadTester struct {
	...
	stateDb fmxdb.Database // Database used by the tester for syncing from peers
	peerDb  fmxdb.Database // Database of the peers containing all data
...
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, fmxproto.ETH66, FastSync) }
...
func TestThrottling66Fast(t *testing.T) { testThrottling(t, fmxproto.ETH66, FastSync) }
...
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, fmxproto.ETH66, FastSync) }
...
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, fmxproto.ETH66, FastSync) }
...
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, fmxproto.ETH66, FastSync) }
...
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, fmxproto.ETH66, FastSync)
}
...
func TestCancel66Fast(t *testing.T)  { testCancel(t, fmxproto.ETH66, FastSync) }
...
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, fmxproto.ETH66, FastSync) }
...
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, fmxproto.ETH66, FastSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", fmxproto.ETH66, chain)
...
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, fmxproto.ETH66, FastSync) }
...
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, fmxproto.ETH66, FastSync) }
...
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, fmxproto.ETH66, FastSync) }
...
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, fmxproto.ETH66, FastSync) }
...
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, fmxproto.ETH66, FastSync)
}
...
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, fmxproto.ETH66, FastSync) }
...
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, fmxproto.ETH66, FastSync) }
...
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, fmxproto.ETH66, FastSync) }
...
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, fmxproto.ETH66, FastSync) }
...
func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, fmxproto.ETH66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, fmxproto.ETH66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, fmxproto.ETH66, LightSync) }
...
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, fmxproto.ETH66, FastSync) }
