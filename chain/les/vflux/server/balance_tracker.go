...
func newBalanceTracker(ns *nodestate.NodeStateMachine, setup *serverSetup, db fmxdb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *balanceTracker {
