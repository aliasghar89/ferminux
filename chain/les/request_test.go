...
type accessTestFn func(db fmxdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db fmxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db fmxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db fmxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db fmxdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
