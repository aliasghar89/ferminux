...
func startLesService(t *testing.T, genesis *core.Genesis, headers []*types.Header) (*node.Node, *les.LightFerminux) {
	t.Helper()
	...
	ethcfg := &fmxconfig.Config{
		Genesis:        genesis,
		Powhash:         powhash.Config{PowMode: powhash.ModeFake},
