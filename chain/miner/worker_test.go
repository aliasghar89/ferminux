...
var (
	...
	powhashChainConfig *params.ChainConfig
...
func init() {
	...
	powhashChainConfig = new(params.ChainConfig)
	*powhashChainConfig = *params.TestChainConfig
...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db fmxdb.Database, n int) *testWorkerBackend {
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db fmxdb.Database, blocks int) (*worker, *testWorkerBackend) {
...
func TestGenerateBlockAndImportPowhash(t *testing.T) {
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	if isClique {
		...
		chainConfig = params.AllPowhashProtocolChanges
...
func TestEmptyWorkPowhash(t *testing.T) {
	testEmptyWork(t, powhashChainConfig, powhash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	powhash := powhash.NewFaker()
	defer powhash.Close()

	w, b := newTestWorker(t, powhashChainConfig, powhash, rawdb.NewMemoryDatabase(), 1)
	defer w.close()
...
func TestRegenerateMiningBlockPowhash(t *testing.T) {
	testRegenerateMiningBlock(t, powhashChainConfig, powhash.NewFaker())
}
...
func TestAdjustIntervalPowhash(t *testing.T) {
	testAdjustInterval(t, powhashChainConfig, powhash.NewFaker())
}
...
func TestGetSealingWorkPowhash(t *testing.T) {
	testGetSealingWork(t, powhashChainConfig, powhash.NewFaker(), false)
}
...
func TestGetSealingWorkPostMerge(t *testing.T) {
	...
	*local = *powhashChainConfig
	local.TerminalTotalDifficulty = big.NewInt(0)
	testGetSealingWork(t, local, powhash.NewFaker(), true)
}
