...
// This file contains a miner stress test based on the Powhash consensus engine.
package main
...
func main() {
	...
	powhash.MakeDataset(1, fmxconfig.Defaults.Powhash.DatasetDir)
...
func makeMiner(genesis *core.Genesis) (*node.Node, *fmx.Ferminux, error) {
