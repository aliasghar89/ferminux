...
func (db *NodeSet) Store(target fmxdb.KeyValueWriter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// NodeList stores an ordered list of trie nodes. It implements fmxdb.KeyValueWriter.
type NodeList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n NodeList) Store(db fmxdb.KeyValueWriter) {
	for _, node := range n {
