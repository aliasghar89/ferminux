...
func TestTxPool(t *testing.T) {
	...
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, powhash.NewFaker(), sdb, poolTestBlocks, txPoolTestChainGen)
	...
	lightchain, _ := NewLightChain(odr, params.TestChainConfig, powhash.NewFullFaker(), nil)
	txPermanent = 50
