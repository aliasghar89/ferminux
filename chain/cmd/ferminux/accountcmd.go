...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Import legacy presale wallet files",
		ArgsUsage: "",
		Description: `
    ferminux wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Ferminux presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	ferminux wallet [options] /path/to/my/presale.wallet
...
between ferminux nodes by simply copying.
...
`,
			},
			{
				...
				Description: `
    ferminux account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    ferminux account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    ferminux account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    ferminux account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another ferminux instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := ferminuxConfig{Node: defaultNodeConfig()}
	// Load config file.
