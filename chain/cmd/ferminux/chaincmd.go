...
It's deprecated, please use "ferminux db import" instead.
`,
	}
...
It's deprecated, please use "ferminux db export" instead.
`,
	}
...
func dumpGenesis(ctx *cli.Context) error {
	...
	if genesis == nil {
		// Ferminux is the default network for this client.
		genesis = core.DefaultFerminuxGenesisBlock()
	}
...
func parseDumpConfig(ctx *cli.Context, stack *node.Node) (*state.DumpConfig, fmxdb.Database, common.Hash, error) {
	db := utils.MakeChainDatabase(ctx, stack, true)
