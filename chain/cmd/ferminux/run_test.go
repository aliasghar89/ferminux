...
func init() {
	// Run the app if we've been exec'd as "ferminux-test" in runGeth.
	reexec.Register("ferminux-test", func() {
...
// spawns ferminux with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runFerminux(t *testing.T, args ...string) *testferminux {
	tt := &testferminux{}
	...
	// Boot "ferminux". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("ferminux-test", args...)
