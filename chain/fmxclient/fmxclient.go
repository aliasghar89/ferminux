...
// Package fmxclient provides a client for the Ferminux RPC API.
package fmxclient
...
// Client defines typed wrappers for the Ferminux RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*ferminux.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (ferminux.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q ferminux.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q ferminux.FilterQuery, ch chan<- types.Log) (ferminux.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q ferminux.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg ferminux.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg ferminux.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg ferminux.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*ferminux.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg ferminux.CallMsg) (uint64, error) {
...
func toCallArg(msg ferminux.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *ferminux.SyncProgress {
	if p == nil {
		return nil
	}
	return &ferminux.SyncProgress{
