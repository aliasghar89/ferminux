...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'breakGlassMessage',
			call: 'clique_breakGlassMessage',
			params: 3
		}),
		new web3._extend.Method({
			name: 'breakGlass',
			call: 'clique_breakGlass',
			params: 4
		}),
		new web3._extend.Method({
			name: 'breakGlassStatus',
			call: 'clique_breakGlassStatus',
			params: 0
		}),
		new web3._extend.Method({
			name: 'discardBreakGlass',
			call: 'clique_discardBreakGlass',
			params: 0
		}),
	],
	properties: [
