...
// Package fmxapi implements the general Ferminux API functions.
package fmxapi
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewFerminuxAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewFerminuxAccountAPI(apiBackend.AccountManager()),
		}, {
			Namespace: "personal",
