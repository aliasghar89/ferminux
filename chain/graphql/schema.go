...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Ferminux address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is a Ferminux account at a particular block.
    type Account {
    ...
    # Transaction is a Ferminux transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches a Ferminux account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches a Ferminux account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches a Ferminux block by number or by hash. If neither is
