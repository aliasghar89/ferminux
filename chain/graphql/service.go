...
func New(stack *node.Node, backend fmxapi.Backend, filterSystem *filters.FilterSystem, cors, vhosts []string) error {
...
func newHandler(stack *node.Node, backend fmxapi.Backend, filterSystem *filters.FilterSystem, cors, vhosts []string) (*handler, error) {
