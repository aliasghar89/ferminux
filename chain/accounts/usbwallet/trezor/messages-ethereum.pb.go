...
// source: messages-ferminux.proto
...
//*
// Request: Ask device for Ferminux address corresponding to address_n path
// @start
// @next FerminuxAddress
// @next Failure
...
//*
// Response: Contains a Ferminux address derived from device private seed
// @end
