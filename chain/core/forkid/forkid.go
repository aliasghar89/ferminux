...
// NewID calculates the Ferminux fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Ferminux fork ID from an existing chain instance.
