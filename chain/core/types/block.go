...
// Package types contains data types related to Ferminux consensus.
package types
...
// DecodeRLP decodes the Ferminux
...
// EncodeRLP serializes b into the Ferminux RLP block format.
