...
type (
	...
	trieGeneratorFn func(db fmxdb.KeyValueWriter, owner common.Hash, in chan (trieKV), out chan (common.Hash))

	// leafCallbackFn is the callback invoked at the leaves of the trie,
	// returns the subtrie root with the specified subtrie identifier.
	leafCallbackFn func(db fmxdb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error)
)
...
func GenerateTrie(snaptree *Tree, root common.Hash, src fmxdb.Database, dst fmxdb.KeyValueWriter) error {
	...
	got, err := generateTrieRoot(dst, acctIt, common.Hash{}, stackTrieGenerate, func(dst fmxdb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
...
func generateTrieRoot(db fmxdb.KeyValueWriter, it Iterator, account common.Hash, generatorFn trieGeneratorFn, leafCallback leafCallbackFn, stats *generateStats, report bool) (common.Hash, error) {
	var (
...
func stackTrieGenerate(db fmxdb.KeyValueWriter, owner common.Hash, in chan trieKV, out chan common.Hash) {
