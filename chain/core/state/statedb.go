...
// Package state provides a caching layer atop the Ferminux state trie.
package state
...
// StateDB structs within the ferminux protocol are used to store anything
...
//
// Carrying over the balance ensures that FMX doesn't disappear.
