...
func ReadSnapshotDisabled(db fmxdb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db fmxdb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db fmxdb.KeyValueWriter) {
...
func ReadSnapshotRoot(db fmxdb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db fmxdb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db fmxdb.KeyValueWriter) {
...
func ReadAccountSnapshot(db fmxdb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db fmxdb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db fmxdb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db fmxdb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db fmxdb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db fmxdb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db fmxdb.Iteratee, accountHash common.Hash) fmxdb.Iterator {
...
func ReadSnapshotJournal(db fmxdb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db fmxdb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db fmxdb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db fmxdb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db fmxdb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db fmxdb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db fmxdb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db fmxdb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db fmxdb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db fmxdb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db fmxdb.KeyValueWriter, status []byte) {
