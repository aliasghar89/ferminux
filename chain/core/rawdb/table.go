...
func NewTable(db fmxdb.Database, prefix string) fmxdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(fmxdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader fmxdb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) fmxdb.Iterator {
...
func (t *table) NewBatch() fmxdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) fmxdb.Batch {
...
func (t *table) NewSnapshot() (fmxdb.Snapshot, error) {
...
func (b *tableBatch) Replay(w fmxdb.KeyValueWriter) error {
