...
# 1. install ferminux for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ferminux
# 5. create ferminux, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable FERMINUX_SOCKET
...
!define GROUPNAME "Ferminux"
!define APPNAME "Ferminux"
!define DESCRIPTION "Official Go implementation of the Ferminux protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ferminux is installed global
