Name "ferminux ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/aliasghar89/ferminux/issues"
!define UPDATEURL "https://github.com/aliasghar89/ferminux/releases"
!define ABOUTURL "https://ferminux.net"
...
# Install ferminux binary
Section "Ferminux" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Ferminux}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ferminux.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ferminux.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Ferminux incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ferminux outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Ferminux UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Ferminux incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ferminux.exe" "" "" "Ferminux" 30303 "" "" ""
  SimpleFC::AdvAddRule "Ferminux outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ferminux.exe" "" "" "Ferminux" "" 30303 "" ""
  SimpleFC::AdvAddRule "Ferminux UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ferminux.exe" "" "" "Ferminux" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "FERMINUX_SOCKET" "R" "HKLM" "\\.\pipe\ferminux.ipc"
  ${EnvVarUpdate} $0 "FERMINUX_SOCKET" "A" "HKLM" "\\.\pipe\ferminux.ipc"
